...
function Home() {
  ...
  return (
    <main className='bg-[#395886] bg-[url(/12469780_Wavy_REst-01_Single-07_5-removebg-preview.png)] bg-no-repeat bg-bottom min-h-screen md:h-[92%] flex flex-col items-center gap-6 md:rounded-l-3xl'>
      ...
      {!loading && <h1 className='text-3xl text-center py-6'>Welcome, {clients.firstName}!</h1>}
        ...
        { clients.accounts?.length > 0 ? <Client accounts={clients.accounts}/> : <h2 className='text-xl text-center py-6 w-[80%]'>No pose accounts</h2> }
