  ...
  return (
    <main className='bg-[#395886] bg-[url(/12469780_Wavy_REst-01_Single-07_1-removebg-preview.png)] bg-no-repeat bg-bottom  h-[92%] flex flex-col items-center gap-6 md:rounded-l-3xl'>
      ...
      <section className='flex flex-col items-center gap-4 mb-5'>
        ...
        {loading && <h2 className='text-xl text-black py-6 '>Loading...</h2>}
        <div className='flex flex-wrap justify-center gap-6'>
        {
          clients.loans?.length > 0 ? clients.loans?.map(loan => {return <Account key={loan.id}>
          ...
          </Account>}): <h2 className='text-xl text-black text-center py-6 w-[80%]'>Does not have loans</h2>
        }
        </div>
